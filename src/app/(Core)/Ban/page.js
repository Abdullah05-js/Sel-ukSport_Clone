  ...
  return (
    <div className="flex flex-col items-center justify-center  min-h-screen overflow-auto gap-5">
              ...
              <GradientText
                      ...
                      className="text-xl font-bold p-2  text-center"
                    >
                      <Image src={logo}  className='object-cover rounded-lg w-15 h-15' alt="kura.com" />
                    </GradientText>
        <h1 className="font-extrabold text-2xl">YOU'R <span className="text-red-600">Banned</span> Get Out Here Gezeer.</h1>
        <GradientText
                colors={["#f8fafc", "#fde68a", "#40ffaa", "#f8fafc", "#fde68a"]}
                animationSpeed={2}
                className="text-xl font-bold p-2  text-center"
              >
                <h1 className="text-2xl">Contact us thodex.live@proton.me</h1>
              </GradientText>
