    ...
    return (
        <div className='w-full min-h-screen bg-black'>
            ...
            <div className=" max-w-3xl mx-auto p-6">
                <h1 className="text-3xl font-bold text-center mb-6">DMCA</h1>
                <h2 className="text-2xl font-semibold mb-4">Digital Millennium Copyright Act (DMCA)</h2>
                <h3 className="text-xl font-medium mb-2">Copyright Notices/Complaints:</h3>
                <p className="mb-4">The DMCA provides a legal remedy for copyright owners who believe their rights have been violated. If you believe that your copyrighted work has been infringed upon without your consent and is available on our website, you may notify our designated agent.</p>
                ...
                <p className="mb-4">Contact us via email:</p>
                <p className="text-blue-600 underline">thodex.live@proton.me</p>

                <h2 className="text-2xl font-semibold mt-6 mb-4">إشعار قانون حقوق النشر الرقمية (DMCA)</h2>
                <p className="mb-4">يرجى اتباع أحكام الملاذ الآمن لقانون حقوق المؤلف للألفية الرقمية (DMCA) الصادرة بموجب الفقرة 512 من قانون حقوق النشر الرقمية. إذا كنت تعتقد أن أي مواد محمية بحقوق النشر تنتهك على موقعنا، يرجى إعلامنا فورًا.</p>
                ...
                <p className="mb-4">البريد الأكتروني للاتصال بنا:</p>
                <p className="text-blue-600 underline">thodex.live@proton.me</p>
            </div>
        </div>
